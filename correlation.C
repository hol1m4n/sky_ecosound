...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double altitud_solar(int a,int m,int d,double time)
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double azimut_solar(int a,int m,int d,double time)
{
	double lon=-73.370721; //Longitude
	double lat=5.865964; //Latitude
	double JD=0; //Julian Date Number
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double altitud_lunar(int a,int m,int d,double time)
{
	double lon=-73.370721; //Longitude
	double lat=5.865964; //Latitude
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double azimut_lunar(int a,int m,int d,double time)
{
	double lon=-73.370721; //Longitude
	double lat=5.865964; //Latitude
	double JD=0; //Julian Date Number from epoch 2010 January 0
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double fase_lunar(int a,int m,int d,double time)
{
	double lon=-73.370721; //Longitude
	double lat=5.865964; //Latitude
	double JD=0; //Julian Date Number from epoch 2010 January 0
...
double conversor_horario(int hour, int minute, int second)
{
	double hora_deci;
	hora_deci=hour+(minute/60)+(second/3600);
...
void main_april()
{
	...
	unoA.open("C://root_v5.34.38/fechashoras/abril_mes.txt");
	unoB.open("C://root_v5.34.38/fechashoras/abril_dia.txt");
	unoC.open("C://root_v5.34.38/fechashoras/abril_hora.txt");
	
	for(int i=0;i<16352;i++)
	{
		unoA>>abrilmes[i];
		unoB>>abrildia[i];
		unoC>>abrilhora[i];
	...
	double AprilSA[16352];
	double AprilSH[16352];
	double AprilMA[16352];
	double AprilMH[16352];
	double AprilMP[16352];
	
	for(int i=0;i<16352;i++)
	{
		AprilSA[i]=azimut_solar(year,abrilmes[i],abrildia[i],abrilhora[i]);
	    AprilSH[i]=altitud_solar(year,abrilmes[i],abrildia[i],abrilhora[i]);
	    AprilMA[i]=azimut_lunar(year,abrilmes[i],abrildia[i],abrilhora[i]);
	    AprilMH[i]=altitud_lunar(year,abrilmes[i],abrildia[i],abrilhora[i]);
	    AprilMP[i]=fase_lunar(year,abrilmes[i],abrildia[i],abrilhora[i]);
		
	}
	
	ofstream daily;  //Data
	daily.open("C://root_v5.34.38/fechashoras/valores_astralesAbril.txt");
	for(int i=0;i<16352;i++)
	{
		daily<<AprilSA[i]<<"	"<<AprilSH[i]<<"	"<<AprilMA[i]<<"	"<<AprilMH[i]<<"	"<<AprilMP[i]<<endl;
	}
	daily.close();
...
void graph_test()
{
	...
	c13= new TCanvas("TRI_RMS_SUN","RMS and SUN",1000,1000);
	c13->Divide(1,1);
	c13->cd(1);
	SaRMS= new TGraph2D();
	for(int a=0;a<16352;a++)
	{
		SaRMS->SetPoint(a,SUN[a],MOON[a],RMS[a]);
	}
	SaRMS->Draw("cont4z");
	SaRMS->SetMarkerStyle(20);
	SaRMS->SetTitle("Heights and RMS");
	SaRMS->GetXaxis()->SetTitle("Sun Height");
    SaRMS->GetYaxis()->SetTitle("Moon Height");
...
void second_april()
{
	...
	unoA.open("C://root_v5.34.38/fechashoras/2abril_mes.txt");
	unoB.open("C://root_v5.34.38/fechashoras/2abril_dia.txt");
	unoC.open("C://root_v5.34.38/fechashoras/2abril_hora.txt");
	...
	ofstream daily;  //Data
	daily.open("C://root_v5.34.38/fechashoras/2valores_astralesAbril.txt");
	for(int i=0;i<744;i++)
	{
		daily<<AprilSA[i]<<"	"<<AprilSH[i]<<"	"<<AprilMA[i]<<"	"<<AprilMH[i]<<"	"<<AprilMP[i]<<endl;
	}
